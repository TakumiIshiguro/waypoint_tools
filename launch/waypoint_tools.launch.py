...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'yaml_path',
            default_value='',
            description='Override waypoint YAML path.'),
        DeclareLaunchArgument(
            'waypoint_yaml_path',
            default_value='',
            description='Override waypoint YAML path.'),
        DeclareLaunchArgument(
            'map',
            default_value='',
            description='Override map YAML path.'),
        DeclareLaunchArgument(
            'map_yaml_path',
            default_value='',
            description='Override map YAML path.'),
        DeclareLaunchArgument(
            'rviz_config',
            default_value='',
            description='Override RViz config path.'),
        DeclareLaunchArgument(
            'rviz_config_path',
            default_value='',
            description='Override RViz config path.'),
        DeclareLaunchArgument(
            'frame_id',
            default_value='',
            description='Override frame ID.'),
        DeclareLaunchArgument(
            'use_sim_time',
            default_value='',
            description='Override simulation clock setting.'),
        DeclareLaunchArgument(
            'edit_format',
            default_value='',
            description='Override edit format.'),
        DeclareLaunchArgument(
            'start_map',
            default_value='',
            description='Override map server startup.'),
        DeclareLaunchArgument(
            'start_rviz',
            default_value='',
            description='Override RViz startup.'),
